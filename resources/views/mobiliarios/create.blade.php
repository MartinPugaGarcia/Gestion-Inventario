...
<div class="container">
    ...
    <br>
    <br>
    <form class="bg-white shadow rounded py-3 px-5 row g-3" action="{{route('mobiliarios.store')}}" method="POST">
        @csrf
        <div class="col-md-12">
        ...
        <div class="col-md-6">
            ...
            placeholder="Ingresa la cantidad en stock del mobiliario..."
            value="{{ old('cantidad') }}">
        @error('cantidad')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
