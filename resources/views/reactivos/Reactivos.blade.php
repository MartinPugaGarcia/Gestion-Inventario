...
<head>
    ...
    <title>PDF REACTIVOS</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.4.1/dist/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
</head>
<body>
    <header>
        <p class="text-center">LISTA DE REACTIVOS</p>
    </header>
    <div class="container">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <th scope="row">{{ $reactivo->nombre }}</th>
                    <th scope="row">{{ $reactivo->ingrediente }}</th>
                    <th scope="row">{{ $reactivo->descripcion }}</th>
                    <th scope="row">{{ $reactivo->cantidad }}</th>
                    <th scope="row">{{ $reactivo->fecha_caducidad }}</th>
                </tr>
                @endforeach
            </tbody>
        </table>
