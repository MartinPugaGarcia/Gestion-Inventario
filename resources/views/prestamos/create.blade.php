...
<div class="container">
    <h3>Agregar Prestamo de Instrumento</h3>
    <br>
    <br>
    <form class="bg-white shadow rounded py-3 px-5 row g-3" action="{{route('prestamos.store')}}" method="POST">
        @csrf
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <select name="nombre" onchange="miInstrumento(this)" id="instrumento" class="form-control bg-light shadow-sm">
            <!--<option value="">-- Escoja el instrumento --</option>-->
        ...
        <div class="col-md-12">
            ...
            <!--<option value="">Indique el estado del prestamo</option>-->
