...
<head>
    ...
    <title>PDF EQUIPOS</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.4.1/dist/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
</head>
<body>
    <header>
        <p class="text-center">LISTA DE EQUIPOS</p>
    </header>
    <div class="container">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <th scope="row">{{ $equipo->codigo }}</th>
                    <th scope="row">{{ $equipo->nombre }}</th>
                    <th scope="row">{{ $equipo->descripcion }}</th>
                    <th scope="row">{{ $equipo->marca }}</th>
                    <th scope="row">{{ $equipo->cantidad }}</th>
                    <th scope="row">{{ $equipo->fecha_mantenimiento }}</th>
                </tr>
                @endforeach
            </tbody>
        </table>
