...
<head>
    ...
    <title>PDF INSTRUMENTOS</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.4.1/dist/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
</head>
<body>
    <header>
        <p class="text-center">LISTA DE INSTRUMENTOS</p>
    </header>
    <div class="container">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <th scope="row">{{ $instrumento->codigo }}</th>
                    <th scope="row">{{ $instrumento->nombre }}</th>
                    <th scope="row">{{ $instrumento->descripcion }}</th>
                    <th scope="row">{{ $instrumento->marca }}</th>
                    <th scope="row">{{ $instrumento->cantidad }}</th>
                    <th scope="row">{{ $instrumento->fecha_mantenimiento }}</th>
                </tr>
                @endforeach
            </tbody>
        </table>
